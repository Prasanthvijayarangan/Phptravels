package com.atmecs.php.Standardfile;
...
public class Standardfile {
	...
	public final static String Home_Xpath = Home_file + "resources" + File.separator + "locator" + File.separator;
	...
	public final static String Locator_config = Home_Xpath + "locator.properties";
	public final static String Validation_Home = Home_file + "resources" + File.separator + "validationdata" + File.separator;
	public final static String Validation_config =Validation_Home + "validationdata.properties";
	public final static String Validation_config1 =Validation_Home + "expecteddata.properties";
